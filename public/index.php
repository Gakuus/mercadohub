        ...
        <section id="inicio" class="section active">
            <div class="hero-wrap">
                ...
                <div class="hero-content">
                    ...
                    <h1 class="hero-title">
                        El lugar donde<br>
                        <span class="hero-title-gradient">los gamers</span><br>
                        intercambian
                    </h1>
                    <p class="hero-subtitle">Publica tus items, busca lo que necesitas y truequea con toda la comunidad de forma segura y sencilla.</p>
                    <div class="hero-actions">
                        <button class="hero-btn hero-btn-primary" data-section="items-disponibles">
                        ...
                        <button class="hero-btn hero-btn-secondary" data-section="intercambio">
            ...
            <div class="hero-stats reveal">
                <div class="hero-stat">
                    <span class="hero-stat-num stat-items">0</span>
                    <span class="hero-stat-label">Items publicados</span>
                </div>
                <div class="hero-stat-divider"></div>
                <div class="hero-stat">
                    <span class="hero-stat-num stat-users">0</span>
                    <span class="hero-stat-label">Usuarios activos</span>
                </div>
                <div class="hero-stat-divider"></div>
                <div class="hero-stat">
                    <span class="hero-stat-num stat-trades">0</span>
                    <span class="hero-stat-label">Intercambios</span>
                </div>
            </div>

            <div class="how-it-works reveal">
                <h2 class="section-label">Como funciona</h2>
                <h3 class="hiw-title">Tres pasos para <span class="hero-accent">intercambiar</span></h3>
                <div class="hiw-steps">
                    <div class="hiw-step">
                        <div class="hiw-step-bg"></div>
                        ...
                        <p>Subi fotos y descripcion. Cuanto mas detalle, mas chances de encontrar un buen trueque.</p>
                    </div>
                    <div class="hiw-connector">
                        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
                    </div>
                    <div class="hiw-step">
                        <div class="hiw-step-bg"></div>
                        ...
                        <p>Explora y filtra por categoria. Seguro hay alguien que tiene justo lo que necesitas.</p>
                    </div>
                    <div class="hiw-connector">
                        <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>
                    </div>
                    <div class="hiw-step">
                        ...
                        <h3>Intercambia</h3>
                        <p>Envía propuestas y coordina el intercambio directamente con otros miembros.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="hero-features reveal">
                ...
                <div class="hero-feature-card">
                    ...
                    <p>No cobramos comisiones por los intercambios. La comunidad se sostiene entre todos.</p>
                </div>
            </div>
        </section>
